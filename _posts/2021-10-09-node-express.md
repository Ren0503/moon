...
Để xử lý các lỗi phát sinh trong quá trình thực thi code không đồng bộ trong Express (phiên bản <5.x), các dev phải tự bắt lỗi và gọi in-built error handler middleware bằng hàm `next()`. Đây là cách thực hiện:
